        ...
        <section className="team" id="team">
          ...
          <div className="team_content">
            <h2 className="team_title_header">
              ...
              <span className="teamtitle">Crew</span>
            </h2>
          </div>

          <section className="team_container">
            <header className="team_header">
              <h1 className="team_title">President</h1>
            </header>
          </section>
            ...
            {SDFive.map((team) => (
              <div className="card" key={team.id}>
                ...
                <div className="profile-pic">
                  <img src={team.profileImage || Profile} alt="Profile" />
                </div>
                <div className="bottom">
                  ...
                  <div className="bottom-bottom">
                    ...
                    <button
                      className="button"
                      onClick={() => {
                        window.location.href = `mailto:${team.mail}`;
                      }}
                    >
                      Contact Me
                    </button>
          ...
          <section className="team_container0">
            <header className="team_header7">
              <h1 className="team_title7">Treasurer</h1>
            </header>
            <header className="team_header7">
              <h1 className="team_title7">Secretary</h1>
            </header>
          </section>
          ...
          <section className="team_container1">
            <header className="team_header1">
              <h1 className="team_title1">Domain Heads</h1>
            </header>
          </section>
          ...
          <section className="team_container1">
            <header className="team_header1">
              <h1 className="team_title1">Domain Representatives</h1>
            </header>
          </section>
